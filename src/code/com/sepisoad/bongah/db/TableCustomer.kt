...
object TableCustomer{
  final val TABLE_NAME = "CUSTOMER"

  fun insert(obj: CustomerInfo): Boolean {
    var result = false
...
"""
  ...
  fun find(name: String, phone: String): MutableList<CustomerInfo>{
    var result: MutableList<CustomerInfo> = mutableListOf()
    val c = DbManager.getConnection()
    val q =
      """
...
"""
  ...
  fun update(obj: CustomerInfo, id: Int): Boolean {
    var result = false
    val c = DbManager.getConnection()
    val q =
      """
