...
object LandFormPrinter {
  fun print(app: Application, orientation: NodeOrientation, obj: LandInfo){
    val root = VBox()
  ...
  fun renderForm(root: VBox, obj: LandInfo){
    ...
    val textDocTypeValue = Text(PROPS.getProperty("land"))
    ...
    val textApplicationTypeTitle = Text(PROPS.getProperty("applicationType") + ": " )
    val textApplicationTypeValue = Text(obj.applicationType.toString())
    ...
    hBoxInfo3.children.addAll(
      ...
      Separator(Orientation.VERTICAL),
      textApplicationTypeTitle, textApplicationTypeValue,
      Separator(Orientation.VERTICAL),
    ...
    val textIsLandAcres = if(obj.isLandAcres)
      Text(PROPS.getProperty("statementLandIsAcres")) else
      Text(PROPS.getProperty("statementLandIsNotAcres"))
    val textIsHouseIncluded = if(obj.isHouseIncluded)
      Text(PROPS.getProperty("statementHouseIncluded")) else
      Text(PROPS.getProperty("statementNoHouseIncluded"))
